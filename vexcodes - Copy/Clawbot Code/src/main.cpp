...
vex::motor Arm2             = vex::motor(vex::PORT10, true);
...
LeftMotor.spin(vex::directionType::fwd, 40, vex::velocityUnits::pct);
RightMotor.spin(vex::directionType::fwd, 40, vex::velocityUnits::pct);
...
void usercontrol( void ) {
  ...
  Controller2.Screen.print("Easy Pickings");
